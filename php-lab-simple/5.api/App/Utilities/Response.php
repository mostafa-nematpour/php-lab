...
class Response
{
    public static function respond($data, $status_code = self::HTTP_OK)
    {
        ...
        $response = [
            ...
            'http_massage' => self::STATUS_TEXTS[$status_code],
            'data' => $data,
        ];
    ...
    public static function setHeaders($status_code=self::HTTP_OK)
    {
        ...
        header('Access-Control-Allow-Headers: Content-Type, Access-Control-Allow-Headers, Authentication, X-Requested-With');
